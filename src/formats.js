...
const conversionMap = {
  ...
  'dur-seconds→dur-ms': (i) => (parseFloat(i) * 1000).toFixed(0),
  'dur-ms→dur-minutes': (i) => (parseFloat(i) / 60000).toFixed(6).replace(/\.?0+$/, ''),
  'dur-minutes→dur-ms': (i) => (parseFloat(i) * 60000).toFixed(0),
  'dur-ms→dur-hours': (i) => (parseFloat(i) / 3600000).toFixed(8).replace(/\.?0+$/, ''),
  'dur-hours→dur-ms': (i) => (parseFloat(i) * 3600000).toFixed(0),
  'dur-ms→dur-days': (i) => (parseFloat(i) / 86400000).toFixed(8).replace(/\.?0+$/, ''),
  'dur-days→dur-ms': (i) => (parseFloat(i) * 86400000).toFixed(0),
  // weeks
  'dur-weeks→dur-days': (i) => (parseFloat(i) * 7).toFixed(2).replace(/\.?0+$/, ''),
  'dur-days→dur-weeks': (i) => (parseFloat(i) / 7).toFixed(4).replace(/\.?0+$/, ''),
  'dur-weeks→dur-hours': (i) => (parseFloat(i) * 168).toFixed(2).replace(/\.?0+$/, ''),
  ...
  'grams→milligrams': (i) => (parseFloat(i) * 1000).toFixed(2).replace(/\.?0+$/, ''),
  'milligrams→grams': (i) => (parseFloat(i) / 1000).toFixed(6).replace(/\.?0+$/, ''),
  'kg→milligrams': (i) => (parseFloat(i) * 1e6).toFixed(0),
  'milligrams→kg': (i) => (parseFloat(i) * 1e-6).toFixed(8).replace(/\.?0+$/, ''),
  'oz→milligrams': (i) => (parseFloat(i) * 28349.5).toFixed(2).replace(/\.?0+$/, ''),
  'milligrams→oz': (i) => (parseFloat(i) / 28349.5).toFixed(6).replace(/\.?0+$/, ''),
  'milligrams→micrograms': (i) => (parseFloat(i) * 1000).toFixed(2).replace(/\.?0+$/, ''),
  'micrograms→milligrams': (i) => (parseFloat(i) / 1000).toFixed(6).replace(/\.?0+$/, ''),
  'grams→micrograms': (i) => (parseFloat(i) * 1e6).toFixed(0),
  'micrograms→grams': (i) => (parseFloat(i) * 1e-6).toFixed(8).replace(/\.?0+$/, ''),
  'grams→carats': (i) => (parseFloat(i) * 5).toFixed(4).replace(/\.?0+$/, ''),
  'carats→grams': (i) => (parseFloat(i) / 5).toFixed(4).replace(/\.?0+$/, ''),
  ...
  'cubic-m→liters': (i) => (parseFloat(i) * 1000).toFixed(2).replace(/\.?0+$/, ''),
  'gallons→cubic-m': (i) => (parseFloat(i) * 0.00378541).toFixed(8).replace(/\.?0+$/, ''),
  'cubic-m→gallons': (i) => (parseFloat(i) / 0.00378541).toFixed(4).replace(/\.?0+$/, ''),
  'cubic-ft→liters': (i) => (parseFloat(i) * 28.3168).toFixed(4).replace(/\.?0+$/, ''),
  'liters→cubic-ft': (i) => (parseFloat(i) / 28.3168).toFixed(6).replace(/\.?0+$/, ''),
  'cubic-ft→cubic-m': (i) => (parseFloat(i) * 0.0283168).toFixed(6).replace(/\.?0+$/, ''),
  'cubic-m→cubic-ft': (i) => (parseFloat(i) / 0.0283168).toFixed(4).replace(/\.?0+$/, ''),
  ...
  'dyne→pound-force': (i) => (parseFloat(i) / 444822).toFixed(8).replace(/\.?0+$/, ''),
  ...
  'mm→pica': (i) => (parseFloat(i) * 6 / 25.4).toFixed(4).replace(/\.?0+$/, ''),
